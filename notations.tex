...
% sns[3]  {0.21, 0.06, 0.42} % (54,  115, 107)
% sns[6]  {0.45, 0.12, 0.51} % (115,  31, 130)
% sns[10] {0.75, 0.22, 0.46} % (191,  56, 117)
% sns[13] {0.94, 0.38, 0.36}
% sns[15] {0.99, 0.56, 0.39} % (255, 142, 100)
% sns[17] {1.00, 0.73, 0.51} % (254, 187, 129)
% sns[19] {0.99, 0.91, 0.66}
\definecolor{sns_blue}{rgb}{0.21, 0.06, 0.42}    % (54,  115, 107)
\definecolor{sns_violet}{rgb}{0.45, 0.12, 0.51}  % (115,  31, 130)
\definecolor{sns_orange}{rgb}{0.75, 0.22, 0.46}  % (191,  56, 117)
\definecolor{sns_yellow}{rgb}{0.99, 0.91, 0.66}  % (252, 232, 168)
...
\colorlet{link_color}{Maroon}

\colorlet{ood_color}{gray!20}
\colorlet{methodColor}{cyan!20}
...
\newcommand{\myself}{\textit{Abhinav Kumar}\xspace}
...
\newcommand{\scaleFractionSeaBird}{0.8}
...
\newcolumntype{d}{>{\columncolor{ood_color}}c}
...
\newcommand{\leftarrowRHD}{\rotatebox[origin=c]{180}{$\rightarrowRHD$}}
...
\newcommand{\rightarrowRHDSmall}{\raisebox{0.05\normalbaselineskip}{\scalebox{0.75}{$\rightarrowRHD$}}}   %$\uparrow$
\newcommand{\leftarrowRHDSmall}{\raisebox{0.05\normalbaselineskip}{\scalebox{0.75}{$\leftarrowRHD$}}} %$\downarrow$
...
% High Frequency
%===============================================================================
\newcommand{\lowFreq}{low-frequency\xspace}
\newcommand{\LowFreq}{Low-frequency\xspace}
\newcommand{\highFreq}{high-frequency\xspace}
\newcommand{\HighFreq}{High-frequency\xspace}

\newcommand{\qConv}{Qonvolution\xspace}
\newcommand{\qConvs}{Qonvolutions\xspace}
\newcommand{\qConvFull}{Queried-Convolution\xspace}
\newcommand{\qConvsFull}{Queried-Convolutions\xspace}

\newcommand{\mlp}{MLP\xspace}
\newcommand{\mlps}{MLPs\xspace}
\newcommand{\cnn}{CNN\xspace}
\newcommand{\cnns}{CNNs\xspace}
\newcommand{\lcns}{LCNs\xspace}
\newcommand{\fcns}{FCNs\xspace}
\newcommand{\qnn}{QNN\xspace}
\newcommand{\qnns}{QNNs\xspace}

\newcommand{\siren}{SIREN\xspace}
\newcommand{\qiren}{QIREN\xspace}
\newcommand{\hashGrid}{hash-grid\xspace}
\newcommand{\hashGrids}{hash-grids\xspace}
\newcommand{\HashGrid}{Hash-grid\xspace}
\newcommand{\HashGrids}{Hash-grids\xspace}

\newcommand{\freqSym}{f}
\newcommand{\power}{\alpha}
...
\newcommand{\srThree}{SR3\xspace}
\newcommand{\realEsrgan}{Real-ESRGAN\xspace}
...
\newcommand{\sfm}{SfM\xspace}

% Datasets
\newcommand{\mipNerf}{Mip-\nerf}
\newcommand{\tAndT}{Tank \& Temples\xspace}
\newcommand{\deepBlend}{Deep Blending\xspace}
\newcommand{\ommo}{OMMO\xspace}
\newcommand{\shelly}{Shelly\xspace}
\newcommand{\synNerf}{Syn-\nerf}
\newcommand{\synthNerf}{Synthetic-\nerf}

% Metrics
\newcommand{\psnr}{PSNR\xspace}
\newcommand{\ssim}{SSIM\xspace}
\newcommand{\lpips}{LPIPS\xspace}
\newcommand{\sep}{/\xspace}

% Ranking
\newcommand{\firstF}[1]{\hspace{-0.9\fboxsep}\colorbox{sns_violet!60}{\textbf{#1}}\hspace{-0.9\fboxsep}}
\newcommand{\secondF}[1]{\hspace{-0.9\fboxsep}\colorbox{sns_yellow}{\textit{#1}}\hspace{-0.9\fboxsep}}
\newcommand{\taken}{$^\dagger$}

% Previous NeRF Papers
\newcommand{\mipNerfTSO}{Mip-\nerf 360\xspace}
\newcommand{\zipNerf}{Zip-\nerf\xspace}
...
\newcommand{\pixelNerf}{PixelNeRF\xspace}

% Previous 3DGS Papers
\newcommand{\mcmc}{MCMC\xspace}
...
\newcommand{\monoRecon}{MonoRecon\xspace}
...
\newcommand{\argoverse}{Argoverse\xspace}
...
\newcommand{\procThor}{ProcTHOR\xspace}
\newcommand{\pascalThreeD}{Pascal3D\xspace}
\newcommand{\arkit}{ARKITScenes\xspace}
\newcommand{\hypersim}{Hypersim\xspace}
\newcommand{\objectron}{Objectron\xspace}
\newcommand{\sunRGBD}{SunRGBD\xspace}
\newcommand{\omniThreeD}{Omni3D\xspace}
\newcommand{\objaverse}{Objaverse\xspace}
\newcommand{\coda}{CODa\xspace}
...
\newcommand{\apThreeDSeventy}{\ap$_{\!3\text{D}\!}$ 70\xspace}
...
\newcommand{\groomedNMSFull}{Grouped Mathematically Differentiable NMS\xspace}
\newcommand{\groomedNMSShort}{GrooMeD\xspace}
\newcommand{\monoDISMulti}{MonoDIS-M\xspace}
\newcommand{\gupNet}{GUP Net\xspace}
\newcommand{\deviant}{DEVIANT\xspace}
\newcommand{\deviantFull}{Depth Equivariant Network\xspace}
...
\newcommand{\bevHeight}{BEVHeight\xspace}
\newcommand{\hopWithMethod}{HoP+SeaBird\xspace}
\newcommand{\stxd}{STXD\xspace}
\newcommand{\cubeRCNN}{Cube R-CNN\xspace}
\newcommand{\unimode}{UniMODE\xspace}
\newcommand{\seabird}{SeaBird\xspace}
\newcommand{\seabirdFull}{Segmentation in Bird's View\xspace}
\newcommand{\charmer}{CHARM3R\xspace}
\newcommand{\charmerFull}{Camera Height Agnostic Monocular 3D Object Detector\xspace}
...
\newcommand{\geDepth}{GEDepth\xspace}
\newcommand{\metricThreeD}{Metric3D\xspace}
\newcommand{\metricThreeDvTwo}{Metric3Dv2\xspace}
\newcommand{\uniDepth}{UniDepth\xspace}
...
% Lie Group Theory
\newcommand{\planeNormalPlain}{n}
\newcommand{\planeNormal}{\mathbf{\planeNormalPlain}}
\newcommand{\plNormalX}{\planeNormalPlain_X}
\newcommand{\plNormalY}{\planeNormalPlain_Y}
\newcommand{\plNormalZ}{\planeNormalPlain_Z}
\newcommand{\predictedHomo}{\mathbf{P}}
\newcommand{\dominantHomo}{\mathbf{D}}
\newcommand{\dominantHomoEigValue}{\mathbf{\Lambda}}
\newcommand{\dominantHomoEigMatrix}{\mathbf{E}}
\newcommand{\tangentWeight}{w}

% Domain Generalization / Camera Height
\newcommand{\ood}{OOD\xspace}
\newcommand{\outDomain}{OOD\xspace}
\newcommand{\inDomain}{ID\xspace}
\newcommand{\camConvs}{CAM-Convs\xspace}
\newcommand{\Variation}{Height\xspace}
\newcommand{\variation}{height\xspace}
\newcommand{\variations}{heights\xspace}
\newcommand{\zeroThreeD}{\bm{0}}
\newcommand{\egoHeight}{H}
\newcommand{\egoHeightChange}{\Delta H}
\newcommand{\uniDrive}{UniDrive\xspace}
\newcommand{\uniDrivePlus}{UniDrive++\xspace}
\newcommand{\sourceExt}{SourceExt\xspace}
\newcommand{\newDepth}{\depthPred_{\egoHeightChange}}
\newcommand{\oldDepth}{\depthPred_{0}}
\newcommand{\depthGround}{{}^{g}\!\depthPred}
\newcommand{\depthRegress}{{}^{r}\!\depthPred}
\newcommand{\newDepthGround}{{}^{g}\!\newDepth}
\newcommand{\oldDepthGround}{{}^{g}\!\oldDepth}
\newcommand{\newDepthRegress}{{}^{r}\!\newDepth}
\newcommand{\oldDepthRegress}{{}^{r}\!\oldDepth}
\newcommand{\depthSlope}{\beta}
\newcommand{\depthGTMax}{\depthGT_{max}}
\newcommand{\depthGTMin}{\depthGT_{min}}
\newcommand{\heightImage}{h}
\newcommand{\pixUBottom}{\pixU_b}
\newcommand{\pixVBottom}{\pixV_b}
\newcommand{\pixUCenter}{\pixU_c}
\newcommand{\pixVCenter}{\pixV_c}
\newcommand{\heightBoxTwoD}{h_{2D}}
\newcommand{\pixUCenterTwoD}{\pixU_{c,2D}}
\newcommand{\pixVCenterTwoD}{\pixV_{c,2D}}
\newcommand{\relu}{ReLU\xspace}
\newcommand{\plucker}{Plucker\xspace}
\newcommand{\ray}{\overrightarrow{r}}
\newcommand{\trend}{trend\xspace}
\newcommand{\trends}{trends\xspace}
...
\newcommand{\extrinsicTrans}{\mathbf{T}}
...
\newcommand{\manifold}{manifold\xspace}
...
\newcommand{\varY}{Y}
\newcommand{\varZ}{Z}
\newcommand{\depthOne}{m}
\newcommand{\depthTwo}{n}
\newcommand{\posX}{x}
\newcommand{\posY}{y}
\newcommand{\posZ}{z}
\newcommand{\posXTwo}{X'}
